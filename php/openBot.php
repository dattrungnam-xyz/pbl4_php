...
if (isset($_SESSION['login']) && $_SESSION['login'] == true) {
    ...
    if ((isset($status) && $status == 1) || $ID == "All") {
        echo '<form class="content_form" method="post" action="openBot.php';
        if ($ID != "All") {
            echo '?ID=' . $ID . '';
        }
        echo ' " id="cmdform">
                            <div class="content_element">
                                ...
                                <input class="content_element-input" id="ip" type="text" name="ip" readonly value="' . $ip . '" />
                            </div>
                            <div class="content_element">
                                <label class="content_element-label" for="port">PORT:</label>
                                <input class="content_element-input" id="port" type="text" name="port" readonly value="' . $port . '" />
                            </div>
        ...
        echo '<p style="font-size:20px;">Bot is non active</p>';
    }
